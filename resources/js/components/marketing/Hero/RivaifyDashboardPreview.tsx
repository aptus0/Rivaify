...
const STAT_CARDS = [
  ...
  { label: 'Siparişler', value: '1.284', delta: '+6,1%' },
  { label: 'Müşteriler', value: '4.892', delta: '+3,8%' },
...
function MiniChart() {
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} preserveAspectRatio="none" className="h-20 w-full">
      ...
      <polygon points={areaPoints} fill="url(#hero-chart-fill)" />
      <polyline
        points={linePoints}
        fill="none"
        stroke="#FF6B00"
...
export function RivaifyDashboardPreview() {
  return (
    <div className="overflow-hidden rounded-2xl border border-dark/[0.08] bg-white shadow-[0_40px_80px_-30px_rgba(13,17,23,0.35)]">
      ...
      <div className="flex">
        ...
        <div className="min-w-0 flex-1 p-5 sm:p-7">
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            {STAT_CARDS.map((card) => (
              <div key={card.label} className="rounded-xl border border-dark/[0.06] bg-white p-4">
          ...
          <div className="mt-4 flex items-center justify-between rounded-xl border border-dark/[0.06] bg-white p-4">
