    ...
    <>
      ...
      <BentoVisual>
        <div className="flex items-center justify-between text-[11px]">
          <span className="text-dark/50">Toplam</span>
          <span className="font-bold text-dark">₺4.499</span>
        </div>
        <div className="mt-2 h-7 rounded-full bg-primary" />
      </BentoVisual>
    </>
  );
}
        ...
        <div className="flex flex-col gap-1.5">
          {['#1058', '#1057'].map((id) => (
            <div key={id} className="flex items-center justify-between text-[11px]">
              <span className="font-semibold text-dark">{id}</span>
...
function InventoryTile() {
  return (
    <>
      ...
      <BentoVisual>
        <div className="flex items-center justify-between text-[11px]">
          <span className="text-dark/50">248 ürün senkronize</span>
        </div>
  ...
  return (
    <>
      ...
      <BentoVisual>
        <div className="grid grid-cols-3 gap-1.5">
          {[0, 1, 2].map((i) => (
            <div key={i} className="aspect-square rounded-control bg-surface-orange" />
          ))}
        </div>
      </BentoVisual>
    </>
...
function AnalyticsTile() {
  ...
  return (
    <>
      ...
      <BentoVisual>
        <div className="flex items-center justify-between text-[11px]">
          <span className="text-dark/50">Net satış</span>
          <span className="font-bold text-primary">+18,4%</span>
        </div>
        ...
        <BentoCard size="hero" variant="subtle">
          <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="max-w-md text-sm text-dark/50">
